...
Study these correctly extracted records and match their granularity and naming (especially for probe_material = the concise key sensing species, and test_medium = base medium only):
