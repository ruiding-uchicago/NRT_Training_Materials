...
"records": [
    {
      ...
      "source_quote": "(the exact sentence from the text that the detection limits and key values came from)"
    }
...
6. source_quote: copy the exact sentence (verbatim) from the paper that the detection limits and main values were taken from. This lets a reader verify the extraction against the text.
